...
external_url 'https://gitlab.dataserve.com.sa'
...
###! **remember to close this block with 'EOS' below**
 gitlab_rails['ldap_servers'] = YAML.load <<-'EOS'
   main: # 'main' is the GitLab 'provider ID' of this LDAP server
     label: 'LDAP'
     host: 'dataserve.com.sa'
     port: 389
     uid: 'sAMAccountName'
     bind_dn: 'CN=gettest,OU=Temp Users,OU=DataServe,OU=ms365-cloud,DC=dataserve,DC=com,DC=sa'
     password: 'P@$$w0rd123'
     ...
     base: 'DC=dataserve,DC=com,DC=sa'
#     user_filter: ''
#     ## EE only
#     group_base: ''
#     admin_group: ''
...
letsencrypt['contact_emails'] = ['mahmouds@dataserve.com.sa','mfathy@dataserve.com.sa','mohamed.issa@dataserve.com.sa'] # This should be an array of email addresses to add as contacts
